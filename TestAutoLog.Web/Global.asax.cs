...
namespace TestAutoLog.Web {
    public class Global : System.Web.HttpApplication {
        ...
        protected void Session_Start(Object sender, EventArgs e) {
            Tracing.Initialize();
            WebApplication.SetInstance(Session, new TestAutoLogAspNetApplication());
            ...
            ((AuthenticationStandardLogonParameters)SecuritySystem.LogonParameters).UserName = "report";
